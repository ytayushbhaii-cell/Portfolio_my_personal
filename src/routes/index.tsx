...
import {
  ...
  Sparkles, Rocket, Code2, Shield, Heart, CheckCircle2,
} from "lucide-react";
    ...
    <>
      ...
      <section className="relative overflow-hidden hero-bg">
        <div className="mx-auto max-w-7xl px-4 pt-20 pb-16 sm:px-6 lg:px-8 lg:pt-28 lg:pb-24">
          <div className="mx-auto max-w-4xl text-center">
            <div className="animate-fade-up inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-1.5 text-xs font-semibold text-muted-foreground shadow-sm">
              <Sparkles className="h-3.5 w-3.5 text-primary" />
              Available for freelance projects
            </div>

            <h1 className="animate-fade-up-delay-1 mt-6 font-display text-4xl font-black tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <p className="animate-fade-up-delay-2 mx-auto mt-6 max-w-2xl text-base text-muted-foreground sm:text-lg">
        ...
        <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-display text-3xl font-bold tracking-tight sm:text-4xl">Featured Projects</h2>
            </div>
      ...
      {latest.length === 0 && (
        <section className="mx-auto max-w-3xl px-4 py-10 text-center sm:px-6 lg:px-8">
          <div className="surface-card p-10">
            ...
            <h3 className="mt-4 font-display text-xl font-semibold">Projects launching soon</h3>
      ...
      {categories.length > 0 && (
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-2 font-display text-3xl font-bold tracking-tight sm:text-4xl">Browse by Category</h2>
          </div>
        ...
        <div className="surface-card overflow-hidden p-8 sm:p-12">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-2 font-display text-3xl font-bold tracking-tight sm:text-4xl">Craft. Speed. Reliability.</h2>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-24 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl btn-primary p-10 text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">Have a project in mind?</h2>
