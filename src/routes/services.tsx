...
import { ArrowRight, Bot, Code2, Globe, Palette, Smartphone, Zap } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-2 text-4xl font-bold tracking-tight sm:text-5xl">What I can build for you.</h1>
      ...
      <div className="mt-16 surface-card p-10 text-center">
        <h2 className="text-2xl font-bold tracking-tight">Ready to build something great?</h2>
