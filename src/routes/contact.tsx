  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-2 text-4xl font-bold tracking-tight sm:text-5xl">Let's build something together.</h1>
        ...
        <form onSubmit={onSubmit} className="surface-card p-6 sm:p-8 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1.5 w-full rounded-2xl border border-border bg-background px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
          <button
            type="submit"
